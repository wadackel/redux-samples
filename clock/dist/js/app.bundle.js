...
/***/ function(module, exports, __webpack_require__) {
	...
	var _containersApp = __webpack_require__(201);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsClock = __webpack_require__(198);
	
	var _utilsDates = __webpack_require__(200);
	
	var initialState = (0, _utilsDates.parseTime)(new Date());
	
	function clock(state, action) {
	  if (state === undefined) state = initialState;
	
	  switch (action.type) {
	    case _actionsClock.SYNC_DATE:
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SYNC_DATE = "SYNC_DATE";
	
	exports.SYNC_DATE = SYNC_DATE;
	
	function syncDate() {
	  var time = (0, _utilsDates.parseTime)(new Date());
	  return _extends({
	    type: SYNC_DATE }, time);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _interopRequireWildcard = __webpack_require__(223)["default"];
	...
	var ClockActions = _interopRequireWildcard(_actionsClock);
	
	var _componentsClock = __webpack_require__(224);
	
	var _componentsClock2 = _interopRequireDefault(_componentsClock);
	...
	var App = (function (_Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      var _props$time = this.props.time;
	      var hour = _props$time.hour;
	      var minutes = _props$time.minutes;
	      var seconds = _props$time.seconds;
	      ...
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement(_componentsClock2["default"], {
	          hour: hour,
	          minutes: minutes,
	          seconds: seconds })
	      );
	...
	App.propTypes = {
	  syncDate: _react.PropTypes.func.isRequired,
	...
	exports["default"] = (0, _reactRedux.connect)(function (state) {
	  return { time: state.clock };
	}, function (dispatch) {
	  return (0, _redux.bindActionCreators)(ClockActions, dispatch);
	})(App);
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(207)('getOwnPropertyDescriptor', function($getOwnPropertyDescriptor){
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(KEY, exec){
	  var $def = __webpack_require__(186)
	    , fn   = (__webpack_require__(188).Object || {})[KEY] || Object[KEY]
	    , exp  = {};
	  exp[KEY] = exec(fn);
	  $def($def.S + $def.F * __webpack_require__(197)(function(){ fn(1); }), 'Object', exp);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$create = __webpack_require__(209)["default"];
	
	var _Object$setPrototypeOf = __webpack_require__(211)["default"];
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line no-proto
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(217)(Function.call, getDesc(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsStrings = __webpack_require__(225);
	...
	var Clock = (function (_Component) {
	  ...
	  _createClass(Clock, [{
	    ...
	    value: function render() {
	      ...
	      hour = (0, _utilsStrings.zeroPadding)(hour, 2);
	      minutes = (0, _utilsStrings.zeroPadding)(minutes, 2);
	      seconds = (0, _utilsStrings.zeroPadding)(seconds, 2);
